...
//define('CLIENT_IP', '2019000871'); // ホテル毎に違う
...
/*develop 用*/
define('HTTP', (empty($_SERVER['HTTPS'])?'http://':'https://').$_SERVER['HTTP_HOST']);
...
// define('ROUTE_PLNLIST_HTL5', 'front/plan');
define('URL_PLNLIST_HTL5', HTL5.'/'.URL_PLNLIST);
// define('ROUTE_PLNSEARCH_HTL5', 'front/plan/search');
define('URL_PLNSEARCH_HTL5', HTL5.'/'.URL_PLNSEARCH);
// define('ROUTE_PLNSORT_HTL5', 'front/plan/sort');
define('URL_PLNSORT_HTL5', HTL5.'/'.URL_PLNSORT);
// define('ROUTE_PLNDETAIL_HTL5', 'front/plan/detail/$1');
define('URL_PLNDETAIL_HTL5', HTL5.'/'.URL_PLNDETAIL);
// define('ROUTE_PLNDATE_HTL5', 'front/plan/date/$1');
define('URL_PLNDATE_HTL5', HTL5.'/'.URL_PLNDATE);
// define('ROUTE_PLNRECALCULATION_HTL5', 'front/plan/recalculation');
define('URL_PLNRECALCULATION_HTL5', HTL5.'/'.URL_PLNRECALCULATION);
// define('ROUTE_PLNPAGE_HTL5', 'front/plan/page/$1');
define('URL_PLNPAGE_HTL5', HTL5.'/'.URL_PLNPAGE);
// define('ROUTE_INDEX_HTL5', 'front/plan/index');
define('URL_INDEX_HTL5', HTL5);

/*reserve----------------------------------------*/

// define('ROUTE_RESERVE_HTL5', 'front/reserve/$1');
define('URL_RESERVE_HTL5', HTL5.'/'.URL_RESERVE);
// define('ROUTE_RESERVE_CM_HTL5', 'front/reserve/m_confirm');
define('URL_RESERVE_CM_HTL5', HTL5.'/'.URL_RESERVE_CM);
// define('ROUTE_RESERVE_CNM_HTL5', 'front/reserve/nm_confirm');
define('URL_RESERVE_CNM_HTL5', HTL5.'/'.URL_RESERVE_CNM);
// define('ROUTE_RESERVE_ORDER_HTL5', 'front/reserve/order');
define('URL_RESERVE_ORDER_HTL5', HTL5.'/'.URL_RESERVE_ORDER);
// define('ROUTE_RESERVE_CANCEL_HTL5', 'front/reserve/cancel');
define('URL_RESERVE_CANCEL_HTL5', HTL5.'/'.URL_RESERVE_CANCEL);
// define('ROUTE_RESERVE_EDIT_HTL5', 'front/reserve/edit');
define('URL_RESERVE_EDIT_HTL5', HTL5.'/'.URL_RESERVE_EDIT);
// define('ROUTE_RESERVE_SAVE_HTL5', 'front/reserve/save');
define('URL_RESERVE_SAVE_HTL5', HTL5.'/'.URL_RESERVE_SAVE);
// define('ROUTE_RESERVE_CHECK_HTL5', 'front/reserve/check');
define('URL_RESERVE_CHECK_HTL5', HTL5.'/'.URL_RESERVE_CHECK);
// define('ROUTE_RESERVE_RA_HTL5', 'front/reserve/registafter');
define('URL_RESERVE_RA_HTL5', HTL5.'/'.URL_RESERVE_RA);
// define('ROUTE_RESERVE_SU_HTL5', 'front/reserve/signup');
define('URL_RESERVE_SU_HTL5', HTL5.'/'.URL_RESERVE_SU);
// define('ROUTE_RESERVE_CREDIT_C_HTL5', 'front/reserve/credit_confirm');
define('URL_RESERVE_CREDIT_C_HTL5', HTL5.'/'.URL_RESERVE_CREDIT_C);
// define('ROUTE_RESERVE_CREDIT_S_HTL5', 'front/reserve/credit_setting');
define('URL_RESERVE_CREDIT_S_HTL5', HTL5.'/'.URL_RESERVE_CREDIT_S);

/*user----------------------------------------*/

// define('ROUTE_MYPAGE_HTL5', 'front/user/mypage');
define('URL_MYPAGE_HTL5', HTL5.'/'.URL_MYPAGE);
// define('ROUTE_LOGIN_HTL5', 'front/user');
define('URL_LOGIN_HTL5', HTL5.'/'.URL_LOGIN);
// define('ROUTE_LOGIN_A', 'front/user/login');
define('URL_LOGIN_A_HTL5', HTL5.'/'.URL_LOGIN_A);
// define('ROUTE_LOGOUT_HTL5', 'front/user/logout');
define('URL_LOGOUT_HTL5', HTL5.'/'.URL_LOGOUT);
// define('ROUTE_RSVLOGIN_HTL5', 'front/user/rsvlogin');
define('URL_RSVLOGIN_HTL5', HTL5.'/'.URL_RSVLOGIN);
// define('ROUTE_NMSIGNUP_HTL5', 'front/user/nm_signup');
define('URL_NMSIGNUP_HTL5', HTL5.'/'.URL_NMSIGNUP);
// define('ROUTE_NMCONF_HTL5', 'front/user/nm_confirm');
define('URL_NMCONF_HTL5', HTL5.'/'.URL_NMCONF);
// define('ROUTE_SIGNUP_HTL5', 'front/user/signup');
define('URL_SIGNUP_HTL5', HTL5.'/'.URL_SIGNUP);
// define('ROUTE_REGIST_HTL5', 'front/user/regist');
define('URL_REGIST_HTL5', HTL5.'/'.URL_REGIST);
// define('ROUTE_USER_EDIT_HTL5', 'front/user/edit');
define('URL_USER_EDIT_HTL5', HTL5.'/'.URL_USER_EDIT);
// define('ROUTE_USER_SAVE_HTL5', 'front/user/save');
define('URL_USER_SAVE_HTL5', HTL5.'/'.URL_USER_SAVE);
// define('ROUTE_PASSWORD', 'front/user/password');
define('URL_USER_PASSWORD_HTL5', HTL5.'/'.URL_USER_PASSWORD);
// define('ROUTE_RESET', 'front/user/reset');
define('URL_USER_RESET_HTL5', HTL5.'/'.URL_USER_RESET);
define('URL_USER_RESET_C_HTL5', HTL5.'/'.URL_USER_RESET_C);
define('URL_USER_PASSWORD_RESET_HTL5', HTL5.'/'.URL_USER_PASSWORD_RESET);
